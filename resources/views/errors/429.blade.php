...
<section class="mx-auto max-w-3xl px-5 py-24 text-center sm:px-8 lg:py-32">
    <p class="text-[7rem] font-black leading-none text-broca-accent sm:text-[10rem]" aria-hidden="true">۴۲۹</p>
    <h1 class="mt-2 text-3xl font-black sm:text-5xl">درخواست‌های شما بیش از حد مجاز بوده است</h1>

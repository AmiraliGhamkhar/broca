...
<section class="mx-auto max-w-lg px-4 sm:px-6 py-16 sm:py-24">
    <div class="form-panel p-8 sm:p-10">
        <div class="text-center space-y-2 pb-6 border-b border-hairline-soft">
            <h1 class="font-display text-2xl sm:text-3xl text-ink">تعیین گذرواژهٔ جدید</h1>
            <p class="text-xs text-muted">گذرواژه جدید و امنی برای حساب خود وارد کنید.</p>
        </div>
        ...
        <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-4">
            ...
            <button type="submit" class="w-full mt-2 rounded-full bg-ink py-4 font-bold text-white text-xs hover:bg-rausch-active transition-colors shadow-float">

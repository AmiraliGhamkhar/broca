...
<div class="mb-8">
    ...
    <nav class="mt-4 flex items-center gap-1.5 overflow-x-auto pb-2 scrollbar-none" aria-label="منوی مدیریت">
        ...
        <a href="{{ route('admin.blogs.index') }}"
           class="px-4 py-2.5 rounded-full text-xs font-bold whitespace-nowrap transition-all {{ str_starts_with($currentRoute, 'admin.blogs') ? 'bg-ink text-white shadow-sm' : 'bg-white text-muted hover:bg-surface-soft border border-hairline-soft' }}">
            وبلاگ
        </a>

...
<section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
    <div class="space-y-3 pb-8 border-b border-broca-sand">
        <span class="text-xs font-black text-coral">اسناد حقوقی و تعهدات بالینی</span>
        <h1 class="text-3xl sm:text-4xl font-black text-ink">{{ $heading }}</h1>
        <p class="text-xs text-broca-slate">آخرین به‌روزرسانی: ۱۴۰۳/۰۶/۰۱ · نسخه: {{ config('broca.terms_version') }}</p>
    </div>
    ...
    <div class="mt-8 surface-panel p-8 sm:p-10 text-xs sm:text-sm text-ink/85 leading-8 space-y-6">
        @if ($heading === 'بیانیهٔ پزشکی' || request()->is('medical-disclaimer'))
            <div class="p-4 rounded-2xl bg-coral/10 border border-coral/30 text-coral font-bold space-y-2">
            ...
            <h2 class="text-base font-black text-ink">۱. عدم ارائه مشاوره درمانی</h2>
            <p>
            ...
            <h2 class="text-base font-black text-ink">۲. بازبینی علمی اعضای هیئت علمی</h2>
            <p>
        ...
        @elseif ($heading === 'حریم خصوصی' || request()->is('privacy'))
            <h2 class="text-base font-black text-ink">۱. اطلاعات جمع‌آوری شده</h2>
            <p>
            ...
            <h2 class="text-base font-black text-ink">۲. امنیت پرداخت‌ها</h2>
            <p>
        ...
        @elseif ($heading === 'شرایط استفاده' || request()->is('terms'))
            <h2 class="text-base font-black text-ink">۱. مالکیت فکری و حق نشر</h2>
            <p>
            ...
            <h2 class="text-base font-black text-ink">۲. اشتراک‌های آموزشی</h2>
            <p>
        ...
        @elseif ($heading === 'تماس با بروکا' || request()->is('contact'))
            <h2 class="text-base font-black text-ink">راه‌های ارتباط و پشتیبانی</h2>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div class="p-4 rounded-2xl bg-white/60 border border-broca-sand">
                    ...
                    <span class="font-mono text-xs text-broca-slate" dir="ltr">support@broca.test</span>
                </div>
                <div class="p-4 rounded-2xl bg-white/60 border border-broca-sand">
                    <span class="font-bold text-ink block">ساعات پاسخگویی:</span>
                    <span class="text-xs text-broca-slate">شنبه تا چهارشنبه ۹ الی ۱۷</span>
                </div>
            </div>
        @else
